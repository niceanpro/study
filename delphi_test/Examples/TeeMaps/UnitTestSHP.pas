...
procedure TForm1.Button1Click(Sender: TObject);
  ...
  begin
    case ComboFlat1.ItemIndex of
      ...
      2: LoadMapFromResource(Series1,'TeeSpainShp','TeeSpainShx');
      3: LoadMapFromResource(Series1,'TeeUKShp','TeeUKShx');
    else
      LoadMapFromResource(Series1,'TeeGermanyShp','TeeGermanyShx');
    end;
  end;
...
begin
  TeeOpenGL1.Active:=CheckBox9.Checked;
end;
